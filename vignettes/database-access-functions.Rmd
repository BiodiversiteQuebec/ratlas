...
```{r, eval = TRUE, echo = TRUE}
data <- db_call_function(function_name = "obs_summary", schema = "atlas_api")
head(data)

data <- db_call_function(function_name = "obs_summary", schema = "atlas_api", taxa_keys = c(1, 2, 3), min_year = 2010, max_year = 2015, region_fid = 1, region_type = 'admin')
head(data)
```