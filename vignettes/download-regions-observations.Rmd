...
- `type`: the type of region. Can be one of `admin`, `cadre_eco`, `dom_bio`, `watershed`, `protected` and `hex`
...
sherbrooke <- municipalities_desc |> filter(name == "Ville de Sherbrooke")
sherbrooke |> kable()
```
